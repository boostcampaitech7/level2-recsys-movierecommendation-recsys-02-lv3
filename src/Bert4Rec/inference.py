...
def generate_recommendations(model, users, user_train, num_user, num_item, max_len, idx2user, idx2item, output_path="submission.csv", device="cuda"):
    """
    모델을 사용해 추천 결과를 생성하고 제출 파일로 저장하는 함수.
