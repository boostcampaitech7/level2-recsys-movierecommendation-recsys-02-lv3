...
class Dataloader():
    def __init__(self, config):
        ...
        self.df = pd.read_csv(os.path.join(self.config.dataset['data_path'], 'train_ratings.csv'))
    ...
    def generate_sequence_data(self) -> dict:
        ...
        for user in users:
            ...
            valid = np.random.choice(user_total, size=self.config.dataset['valid_samples'], replace = False).tolist()
