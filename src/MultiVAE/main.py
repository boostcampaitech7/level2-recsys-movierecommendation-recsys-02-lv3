...
if __name__ == "__main__":
    ...
    arg('--config', '-c', '--c', type=str, 
        help='Configuration 파일을 설정합니다.', default='choi/level2-recsys-movierecommendation-recsys-02-lv3/src/MultiVAE/config.yaml')
    ...
    if config_yaml.wandb:
        ...
        wandb.run.log_code("./src/MultiVAE")  # MultiVAE 내의 모든 파일을 업로드. Artifacts에서 확인 가능
